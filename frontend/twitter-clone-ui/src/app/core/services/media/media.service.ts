...
export class MediaService {
  ...
  public uploadMediaFromRemote(file: File): Observable<Media> {
  ...
  public getMediaById(mediaId: string): Observable<Media> {
    return this.httpClient.get<Media>(this.baseURL + 'get/' + mediaId);
  }

  public deleteMediaFromRemote(mediaId: string | undefined): Observable<Media> {
    return this.httpClient.delete<Media>(this.baseURL + 'delete/' + mediaId);
  }

  public deleteCloudinaryMedia(publicId: string | undefined): Observable<Media> {
